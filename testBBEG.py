        ...
        if BGHP > 0:  # While BadGuy HP is greater than 0, Exit value remains False
            ...
            while retry:  # Loop to determine Hero Action
                if heroAct == "A":  # Attack: Take and Deal Full Damage
                    ...
                    heroAct = input(
                        "Invalid Input. Please Enter 'A' to Attack, 'B' to Block, or 'D' to Dodge:")
            ...
            if heroHP > 0:  # While Hero HP is greater than 0, Exit value remains False
                ...
                print(
                    "You have failed. Your soul belongs to me! The shadows surround and consume you. Welcome to Oblivion.")
                Exit = True
        else:  # If BadGuy HP drops to 0, player wins and Exit Value becomes True
            print(
                "You Win! The light swells around you as your soul returns to its earthly vessel. Congratulations!")
            Exit = True
