...
def main_intro():
    ...
    darkness = "\n\n{:^100}".format("Darkness Surrounds You")
    ...
    prCyan("Hey, You! You're finally Awake... \n\nAs your awareness returns to you, you find yourself walking up the shifting slope of a sand dune. A sickle of a moon shines down on you, illuminating the seemingly endless sea of sand that surrounds you. \nYou feel as though you have been walking for days, possibly weeks. Time has long since lost all meaning to you. \nYour eyes and throat are parched and dry, your skin caked with sand. You can't remember ever being this thirsty before in your entire Life. \nThe cool caress of water against your feels like a distant memory. You have no idea where you are or how you got here, all you can remember is the endless sand. \n\nIt's Coarse, and Rough, and Irritating... and it is Everywhere.\n") 
    
    key = input("...\n")

    prCyan("\nYou stumble forward, nearly blind, moving through the sheer force of Will, alone. As the last of your resolve threatens to leave you, your hands come in to contact with rough-hewn wood, bound with metal. \n\nA door.") 
    
    key = input("\nPress Enter to Open the Door.")
    
    os.system('clear')            #clear screen 
   
    prCyan(f"Desperate for shelter, you pull at the handles with all your remaining strength. For a moment, the door does not budge. \nThen, with a sound no louder than a whisper, it swings effortlessly open, revealing a long corridor of smooth stone, expertly fitted together so that the seams between the massive blocks are almost imperceptible. \n\nYou wander the dimly lit halls and stone corridors of the labyrinth, passing frescoes and carvings of strange creatures: birds with the heads of women and men, people with the heads of various animals... The image of a giant set of scales adorns one wall. \nYou walk down endless corridors, dimly lit by an unseen source; unlit torches occupy sconces every few meters yet produce no smoke, nor flame, nor light. \nAfter some time, a faint noise reaches your ears. At first you think they are playing tricks on you, but as you get closer to the source of the sound, you realize that it is, in fact, the sound of falling water. \nDesperate for moisture, your tongue feels like sandpaper as it tries in vain to wet your cracked and bleeding lips. The prospect of quenching your agonizing thirst pulls you forward toward the sound of water. \n\nAs you turn a corner, you step into a vast chamber, the ceiling and far walls shrouded in darkness. The sounds of water come from a trickle of a waterfall that descends from the darkness above you as it splashes into a seemingly endless expanse of dark water that extends into the distance of the cavelike room. \n\nBefore the deathly still pool sits a massive Sphinx, its paws crossed in front of itself, eyes closed. At first you think it is a statue until it opens one great, golden eye and looks down at you with a sharp-toothed smile. \nThe voice of the massive beast rumbles through the cavernous space:")

    prYellow(f"\nCome in {playerName}. I have been expecting you. Come have a drink and sit with me.")
    
    key = input("...\n")
    
    prCyan("Despite his massive size, the Sphinx is a gracious host. He provides you with cool water to drink and gives you a few minutes to rest on the soft sand by the endless underground sea, making occasional polite conversation. \nAfter a time, the guardian speaks once more:")
    
    prYellow("\nNow that you have found a moment of respite, I regret that I must send you on your way. \nYou must Answer me these Riddles Three, ere the other side ye see... When you are ready, proceed to determine your reward.")
...
def treasureChest():
    ...
    if correctAnswers == 0:
        ...
        prYellow(f"\n Come forward, {playerName}, and receive your reward for answering {answerStr} of my riddles correctly. Within this chest is a weapon that will aid you in your final challenge.")
        ...
        prCyan("The Sphinx moves one massive paw revealing an ornate chest of gold, set with precious stones and carved with the likeness of a jackal's head.") 
        prYellow(f"\n Come forward, Hero known as {playerName}, and receive your reward for answering {answerStr} of my riddles correctly. Within this chest is a weapon that will aid you in your final challenge.")
        key = input("\nPress Enter to Open the Chest")
        os.system('clear')
        ...
        prCyan("The Sphinx moves one massive paw revealing an ornate chest of gold, set with precious stones and carved with the likeness of a jackal's head.") 
        prYellow(f"\n Come forward, Mighty {playerName}, and receive your reward for answering {answerStr} of my riddles correctly. Within this chest is a weapon that will aid you in your final challenge.")
        key = input("\nPress Enter to Open the Chest")
        os.system('clear')
...
def combat():
    ...
    prCyan("\n\nYou bid farewell to the Sphinx as you step into the diminuitive vessel. Once you are settled, the coracle drifts away from the shore of its own accord and carries you into the darkness, hardly making a sound as its hull breaks the still water. After awhile, you begin to see tiny pinpricks of light far above you. The stars twinkle and shine in the darkness, illuminating nothing.\nSoon, between the gentle rocking of the tiny boat and the swishing sounds of water against the reed hull, you find yourself drifting in and out of consciousness. You dream briefly of your family members that you have lost. For a time, a favored pet walks beside you; a feeling of security envelops you and restful sleep descends upon you.")
    
    key = input("\n...")
    
    os.system('clear')
    
    prCyan("You wake abruptly as the coracle makes landfall, bumping against a sandy shore. Clearing the sleep from your eyes, you find yourself on the bank of a vast river, the fields surrounding it covered in tall reeds that sway in an unseen wind. The sound of the reeds as they rattle against one another is eerily reminiscent of hollow bone against hollow bone.\nYou step out of the boat and onto the shore, and as you glance behind you the coracle is nowhere to be seen.\nWith no other recourse available, you step forward into the Field of Reeds.")
    
    key = input("\n...")
    os.system('clear')

    prCyan("\nSoon you come to a clearing.\nBefore you stands the imposing figure of a powerfully built man, his chest and arms bare, yet adorned with gold and precious stones. He wears a large headdress atop his Jackal's head. \nHe bares long, viciously sharp teeth in a rictus of a grin as he meets your gaze.\nHis voice is deep, like the rolling of thunder, as he speaks.")
    
    # Monologue
    prYellow(f"\n Welcome, {playerName}. Allow me to introduce myself properly. I am Anubis. \n\nI see that you have bested the Sphinx and found your way to my demesne. \nDespite what you may think, I am not your enemy, I am simply here to test your resolve one last time and to weigh the guilt in your heart against... this.")
    ...
    prYellow("\n However... Of late I have grown bored of this monotony, therefore I propose to you a challenge: I will give you one opportunity to avoid my judgement. Defeat me in combat and I will guide you to the Field of Reeds myself where you may spend eternity in Peace, with all the food and drink you desire. Fail, and your soul will be forfeit. \nPrepare yourself, human! Your fate is at hand!")
    ...
    while not Exit:					#Repeat Hero Turn, BadGuy Turn, and HP Calculation until either HP reaches 0
        ...
        if BGHP > 0:						#While BadGuy HP is greater than 0, Exit value remains False
            ...
            if heroHP > 0:							#While Hero HP is greater than 0, Exit value remains False
                ...
                prRed("You have Failed. You look on in horror as Ammut, a great beast with the head of a Crocodile, the body of a Hippopotamus, and the hindquarters of a Lion, pounces upon you from the shadows behind the Ancient God. You feel no pain as it begins to devour your heart and darkness consumes you once again.")
                key = input("...")
                os.system('clear')
                Exit = True
			
        else:							#If BadGuy HP drops to 0, player wins and Exit Value becomes True
            prBlue("You are Victorious! The ancient god falls to the ground at your feet, bloodied and beaten.")
            key = input("...\n")
            os.system('clear')
            
            prCyan(f"\nAs you watch, Anubis rises gracefully to his feet, his many wounds closing within the span of a single breath. The scarlet blood scattered across your private battlefield is swallowed hungrily by the sandy ground beneath your feet. \nHe takes a deep, almost satisfied breath.")
            ...
            prCyan("\nAnubis reaches out a hand that seems to grow exponentially as it gets closer and closer, blotting out the sun and sky as it engulfs you.")
